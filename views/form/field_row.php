...
if (isset($field->id)):
?><input name="form[fields][<?php echo $current_id; ?>][id]" type="hidden" value="<?php echo $field->id; ?>" /><?php
endif;
...
?><td class="set_required"><input name="form[fields][<?php echo $current_id; ?>][required]" type="checkbox" value="1"<?php if (isset($field->required) && $field->required == 1): ?> checked="checked"<?php endif; ?> /></td><?php
?><td class="delete"><a href="javascript:removeField(<?php echo $current_id; ?>)"><img width="16" height="16" src="<?php echo URL_PUBLIC; ?>wolf/icons/delete-16.png" align="middle" alt="<?php echo __('Delete'); ?>" /></a></td><?php
?></tr>